...
const SRC_ROOT = "src/actors";
const OUT_FILE = "translations/wfrp4e-eis.actors.json";
const output = { label: "WFRP4E Enemy in Shadows – Actors (IT)", entries: {} };
...
console.log("✔ Actors built for Babele");
